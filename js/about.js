...
if(lang == 'ge'){
    ...
    info.innerHTML = `Я Гига Гиоргадзе джуниор веб-разработчик мне 17 лет я младший веб-разработчик из Грузия, без опыта работы в области веб-разработки, но я трудолюбивый и быстро учусь,  сейчас я пытаюсь создать веб-сайт или какую-то веб-игру каждый день, пока что у меня все хорошо, вы можете проверить мою страницу <a href="https://github.com/GigaGiorgadze">GitHub</a> и проверить все мои проекты подробно описаны там, я магу работать онлайн или лично, я могу свободно говорить на русском, английском и грузинском языках, языки на которых я могу кодировать, перечислены ниже`
